...
D29 is locked; specs above are final. Build order (I implement — Cursor limit reached): **P10 foundation** → **{P11, P13, P14}** → **P12**, one PR per pebble, open-and-merge flow. ⚠ P12 (pricing) and P14 (escrow) are money seams carrying heightened-scrutiny review + failure-path tests. **P10 is next.**
