...
> **CCP-08 supersession note:** This is a point-in-time audit. For current SD-06…09
> drift, use `docs/production-readiness/2026-07-20/current-implementation-board.md`
> plus the targeted CCP-08 updates in `docs/ops/ci.md`, `README.md`,
> `docs/plan/00-status.md`, `docs/plan/00-decisions.md`, `docs/designs/TOKENS.md`,
> `docs/ops/drill-log.md`, and release-gate notes. Do not read rows 5/15 below as
> current CI/F7/token/drill truth.
...
| 5   | **CI security gates still need settings proof**    | CCP-08 verified `secret-scan` and Lighthouse are blocking in YAML; `i18n-lint`, demo seed, and broad RLS sweep remain advisory; branch protection/no-bypass evidence still required.                                                                                                  | VE-P04, VE-P06, G8/G19     |
...
| 15  | **Doc drift hygiene (CCP-08)**                     | CCP-08 aligns CI docs/README to current YAML, documents `--primary-btn-fg` / `--primary-btn-hover`, aligns F7 with SOURCES.md's canonical 6 missing files, and adds a current drill-log repo-tip note while preserving historical transcripts.                                        | hygiene                    |
