...
**Source tip:** `cc4a8241d25e4c715903ba4ca161fb95491ff52b`  
**Evidence:** `staging-release-evidence.md`  
**Rule:** Blockers are launch-blocking for STAGING_VERIFIED / real-money enablement. No remediation implemented in this session.
...
| ----- | ------------------- | ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| SB-01 | DEPLOYMENT_REQUIRED | No separable Vergeo5 staging stack                                                   | Supabase has no staging Vergeo5 project; Vercel has no staging apps; `deploy-staging.yml` stub; n8n targets `api.vergeo5.com` | founder / ops      | Provision staging API + DB + storage + n8n + Vercel (or documented preview) with **distinct project IDs** from prod `dpadrlxukcjbewpqympu` / `prj_lK6jnh…` / `api.vergeo5.com` |
