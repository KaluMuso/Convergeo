...
`prompts/fixes/FIX-H-demo-service-event-exclusion.md` · `FIX-I-restocking-fee-unit-unify.md` · `FIX-J-kyc-returns-transition-atomicity.md` · `FIX-K-event-cancellation-notifications.md`. All four branch from + PR against `master`, touch disjoint files, and can run concurrently.
