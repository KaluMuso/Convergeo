...
/**
 * Protected, per-listing route — always rendered per request.
 *
 ...
 *
 * `id` is an arbitrary listing UUID: there is no enumerable set, so no
 ...
 * /[locale]/events/[id]/scan in staging run 35456698878. Listing data is
