...
function resolveLabels(messages: CheckoutShellLabels): ResolvedCheckoutLabels {
  return {
    ...
    contact: {
      ...
      otpDigit: (position, total) =>
        fillTemplate(messages.contact.otpDigitTemplate, { position, total }),
      resend: messages.contact.resend,
      resendIn: (seconds) => fillTemplate(messages.contact.resendInTemplate, { seconds }),
      ...
      throttled: (seconds) => fillTemplate(messages.contact.throttledTemplate, { seconds }),
