...
POLICIES: dict[str, RateLimitPolicy] = {
    ...
    "PATCH /config/category-policies/{category_id}": ADMIN_WRITE,
    ...
    "POST /config/fx-rates": ADMIN_WRITE,
    "POST /governance/vendors/{vendor_id}/reinstate": ADMIN_WRITE,
    ...
    "POST /internal/n8n/cancel-rate-suspend/tick": INTERNAL_CRON,
