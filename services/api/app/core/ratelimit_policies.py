...
POLICIES: dict[str, RateLimitPolicy] = {
    ...
    "POST /account/recently-viewed": STANDARD_WRITE,
    "POST /account/tickets/{ticket_id}/cancel": PAYMENT_WRITE,
    "POST /account/tickets/{ticket_id}/reschedule-opt-out": PAYMENT_WRITE,
    "POST /account/event-team/accept": SENSITIVE_WRITE,
    "PUT /account/wishlist": STANDARD_WRITE,
    "POST /admin/ai-spend/reset-kill-switch": ADMIN_WRITE,
    ...
    "POST /admin/events/{event_id}/high-value-verify": ADMIN_WRITE,
    ...
    "POST /cart/items/{listing_id}/save-for-later": STANDARD_WRITE,
    "POST /cart/merge": STANDARD_WRITE,
    "POST /cart/revalidate": STANDARD_WRITE,
    "POST /cart/rfq/{rfq_id}/accept": STANDARD_WRITE,
    ...
    "POST /internal/privacy/export-purge-tick": INTERNAL_CRON,
    ...
    "POST /kyc/{kyc_record_id}/revoke": ADMIN_WRITE,
    "POST /kyc/{kyc_record_id}/start-review": ADMIN_WRITE,
    "POST /kyc/{kyc_record_id}/suspend": ADMIN_WRITE,
    ...
    "POST /organiser/events/{event_id}/team": STANDARD_WRITE,
    "DELETE /organiser/events/{event_id}/team/{member_id}": STANDARD_WRITE,
    "POST /organiser/events/{event_id}/promos": STANDARD_WRITE,
    "POST /organiser/events/{event_id}/affiliates": STANDARD_WRITE,
    ...
    "PATCH /products/canonical/{product_id}/status": ADMIN_WRITE,
    ...
    "POST /tickets/verify/override": SENSITIVE_WRITE,
    ...
    "PATCH /vendors/{vendor_id}/status": ADMIN_WRITE,
